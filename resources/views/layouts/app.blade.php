            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse text-white" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        <a class="col-xs-10 col-sm-9 col-md-8 col-lg-7 col-xl-6 text-center" href="{{ url('/') }}">
                        {{-- <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-login-form/draw2.svg" class="img-fluid" alt="Phone image"> ./resources/images/4.png--}}
                            <img src="{{asset('./images/2.png')}}" alt="Imagen de referencia para el login" width="40" class="">
                        </a>
                    </ul>
